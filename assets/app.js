...
const FALLBACK={hero_title:'Xüsusi günlərinizi unudulmaz edək',hero_text:'Hər detalda sevgi, hər tədbirdə zövq.',phone:'+994 50 123 45 67',whatsapp:'994501234567',instagram:'decorist_lady',address:'Bakı, Azərbaycan',hours:'Hər gün 09:00 — 20:00'};
...
function nav(c){
  ...
  <nav class="nav">
    <div class="container navin">
      <a class="logo" href="index.html">Decorist Lady <i>♡</i></a>
      <div class="links">
    ...
    <div class="container">
      <div class="footgrid">
        <div class="footer-brand">
          <div class="logo" style="color:#ffffff">Decorist Lady <i>♡</i></div>
